...
playagain_image = pygame.image.load("playagain.png").convert_alpha()
tomainmenu_image = pygame.image.load("tomainmenu.png").convert_alpha()
winbackground = pygame.image.load("winbackground.png").convert()
...
winmenu_images = [playagain_image, tomainmenu_image]
